...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { company_id: @vendor.company_id, name: @vendor.name, site: @vendor.site } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { company_id: @vendor.company_id, name: @vendor.name, site: @vendor.site } }
